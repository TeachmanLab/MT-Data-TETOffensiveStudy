...
└── materials
    ├── data server              # "PUBLIC Instructions for MindTrails teachmanlab Server Data Pull.pdf"
...
### [1_get_raw_data.ipynb](./data_cleaning/code/1_get_raw_data.ipynb)
...
### [2_define_functions.R](./data_cleaning/code/2_define_functions.R)
...
### [3_redact_data.R](./data_cleaning/code/3_redact_data.R)
...
### [4_clean_data.R](./data_cleaning/code/4_clean_data.R)
...
### [5_import_clean_data.R](./data_cleaning/code/5_import_clean_data.R)
